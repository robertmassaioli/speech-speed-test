...
const NINE_RESULTS_WITH_COMPOSITION: StoredResult[] = [
  { id: 'r1', ts: NOW - 9 * 86400000, passageId: 'easy-1', mode: 'lexical', elapsedSec: 36, words: 120, charsRaw: 640, wpm: 200, cpm: 1067, composition: [0.55, 0.37, 0.07, 0.01], difficultyBin: 'easy', frequencyListId: FREQ_LIST_ID },
  { id: 'r2', ts: NOW - 8 * 86400000, passageId: 'easy-2', mode: 'lexical', elapsedSec: 38, words: 118, charsRaw: 630, wpm: 186, cpm: 995, composition: [0.54, 0.38, 0.07, 0.01], difficultyBin: 'easy', frequencyListId: FREQ_LIST_ID },
  { id: 'r3', ts: NOW - 7 * 86400000, passageId: 'easy-3', mode: 'lexical', elapsedSec: 35, words: 115, charsRaw: 620, wpm: 197, cpm: 1063, composition: [0.56, 0.36, 0.07, 0.01], difficultyBin: 'easy', frequencyListId: FREQ_LIST_ID },
  { id: 'r4', ts: NOW - 6 * 86400000, passageId: 'bunny-and-duck', mode: 'lexical', elapsedSec: 52, words: 130, charsRaw: 720, wpm: 150, cpm: 831, composition: [0.50, 0.40, 0.09, 0.01], difficultyBin: 'medium', frequencyListId: FREQ_LIST_ID },
  { id: 'r5', ts: NOW - 5 * 86400000, passageId: 'medium-2', mode: 'lexical', elapsedSec: 54, words: 132, charsRaw: 730, wpm: 147, cpm: 811, composition: [0.51, 0.39, 0.09, 0.01], difficultyBin: 'medium', frequencyListId: FREQ_LIST_ID },
  { id: 'r6', ts: NOW - 4 * 86400000, passageId: 'medium-3', mode: 'strict', elapsedSec: 50, words: 128, charsRaw: 710, wpm: 154, cpm: 852, composition: [0.50, 0.40, 0.09, 0.01], difficultyBin: 'medium', frequencyListId: FREQ_LIST_ID },
  { id: 'r7', ts: NOW - 3 * 86400000, passageId: 'hard-1', mode: 'lexical', elapsedSec: 68, words: 135, charsRaw: 810, wpm: 119, cpm: 714, composition: [0.42, 0.38, 0.15, 0.05], difficultyBin: 'hard', frequencyListId: FREQ_LIST_ID },
  { id: 'r8', ts: NOW - 2 * 86400000, passageId: 'hard-2', mode: 'lexical', elapsedSec: 70, words: 138, charsRaw: 820, wpm: 118, cpm: 703, composition: [0.43, 0.37, 0.15, 0.05], difficultyBin: 'hard', frequencyListId: FREQ_LIST_ID },
  { id: 'r9', ts: NOW - 1 * 86400000, passageId: 'hard-3', mode: 'lexical', elapsedSec: 65, words: 133, charsRaw: 795, wpm: 123, cpm: 734, composition: [0.42, 0.38, 0.14, 0.06], difficultyBin: 'hard', frequencyListId: FREQ_LIST_ID },
]
