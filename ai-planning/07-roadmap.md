...
- Number canonicalisation (custom implementation — no third-party library).
- Live progress highlighting: correct prefix highlighted, first mismatch token flagged.
- Unit tests covering all doc‑03 edge cases (decimals, abbreviations, ordinals, ellipses, multi-sentence alignment).
